...
#define по_наше_молвить_будем setlocale(0, "")
...
#define почта_голубиная <stdio.h>
#define молва_велико_русская <locale.h>

#include почта_голубиная
#include молва_велико_русская


молитва отченаш

по_наше_молвить_будем ъ

цело x стане 0 ъ

молви("Сколько летъ тебе ,братъ мой? ") ъ
поведай("%i", &x) ъ
молви("Тебе %i лет, братъ", x) ъ
